...
class AttachmentService:
            ...
            data.update(
                {
                    ...
                    'user': request.user,
                    'file': file,
                    'project': data['content_type'].get_object_for_this_type(pk=data['object_id']).project
                }
            )
    ...
    def attachment_update(self, attachment: Attachment, data: Dict[str, Any]) -> Attachment:
        ...
        attachment.content_object = attachment.content_type.get_object_for_this_type(pk=data['object_id'])
