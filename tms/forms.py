...
class UserDetailsForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            HTML("""<hr class="mt-0">"""),
            FormActions(Submit('Save', 'Save changes', css_class='btn-secondary'), css_class='mb-0')
        )
...
class ProfilePasswordChangeForm(PasswordChangeForm):
    ...
    def __init__(self, user, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            HTML("""<hr class="mt-0">"""),
            FormActions(Submit('Save', 'Change password', css_class='btn-secondary'), css_class='mb-0')
        )
